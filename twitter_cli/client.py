...
class TwitterClient:
    ...
    def create_tweet(self, text, reply_to_id=None, media_ids=None, community_id=None):
        # type: (str, Optional[str], Optional[List[str]], Optional[str]) -> str
        ...
        Args:
            ...
            community_id: Optional X Community ID to post into.
        """
        media_entities = []
        if media_ids:
        ...
        if community_id:
            ...
            variables["semantic_annotation_options"] = {"source": "Profile"}
            referer = "https://x.com/compose/post"
        if referer:
            data = self._graphql_post("CreateTweet", variables, _CREATE_TWEET_FEATURES, referer=referer)
        else:
    ...
    def _graphql_post(self, operation_name, variables, features=None, referer=None):
        # type: (str, Dict[str, Any], Optional[Dict[str, Any]], Optional[str]) -> Dict[str, Any]
        ...
        def _do_post(qid):
            ...
            return self._api_request(url, method="POST", body=body, referer=referer)
    ...
    def _api_request(self, url, method="GET", body=None, referer=None):
        # type: (str, str, Optional[Dict[str, Any]], Optional[str]) -> Dict[str, Any]
